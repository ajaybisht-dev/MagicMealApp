...
const MyReviews: React.FC = () => {
  ...
  const formatTimeAgo = (dateString: string) => {
    try {
      ...
      // 1️⃣ Clean backend timestamp → keep only first 3 ms digits
  ...
  const handleSubmitServiceProviderRatingFunction = async (data: any) => {
    ...
    let payload = {
      ...
      userID: user_id,
      quantityRating: ratings.Quantity || 0,
      qualityRating: ratings.Quality || 0,
      tasteRating: ratings.Taste || 0,
      freshnessRating: ratings.Freshness || 0,
      packagingRating: ratings.Packing || 0,
  ...
  return (
    <View style={styles.container}>
      ...
      <MyRatingModal
        ...
        // value={
        //   vendorTypeData as "Restaurant" | "Bakery" | "Grocery" | "Butcher"
        // }
        value={'Restaurant'}
        onClose={() => [
