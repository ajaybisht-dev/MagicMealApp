...
const RegistrationScreen: React.FC = () => {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      if (response?.succeeded) {
        ...
        setEmailExistsError(response?.messages[0]);
        setIsSuccess(false);
        setShowToast(true);
  ...
  const openLinkFunction = () => {
    Linking.openURL("http://app.mywebsite.org/services");
  }
              ...
              <View style={{ paddingLeft: 40, paddingRight: 40 }}>
                <View style={styles.inputGroup}>
                  ...
                  <View style={{ marginBottom: 20 }}>
                    ...
                    <TextInput
                      ...
                      value={email}
                      autoCapitalize="none"
                      style={{ borderWidth: 1, borderColor: emailExistsError ? "#D34D40" : "#D6D6D6", borderRadius: 10, paddingVertical: 12, paddingLeft: 14 }}
                      onChangeText={(text) => {
                        setEmail(text);
                        setEmailExistsError("");
                        // const emailError = validateEmail(text);
                        // if (emailError) {
                        //   setValidationError((prev) => ({ ...prev, email: emailError }));
                        // } else {
                  ...
                  <View style={{ marginBottom: 20 }}>
                    ...
                    <TextInputComponent
                      ...
                      onChangeText={(text) => {
                        ...
                        // if (phoneError) {
                        //   setValidationError((prev) => ({ ...prev, phone: phoneError }));
                        // } else {
                ...
                <View style={styles.termsContainer}>
                  ...
                  >
                    ...
                    <View style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                      ...
                      <Pressable onPress={() => openLinkFunction()}><Text style={[styles.termsText, { color: "#264941", fontFamily: FONTS.tenonRegularFont }]}>Terms & Conditions</Text></Pressable>
                    </View>
                  </Pressable>
                  {
                  ...
                  >
                    ...
                    <View>
                      <Text style={[styles.termsText]}>I agree to <Text style={[styles.termsText, { color: "#264941" }]}>subscribe for </Text></Text>
                      <Text style={[styles.termsText, { color: "#264941", fontFamily: FONTS.tenonRegularFont }]}>newsletters & promotions</Text>
                    </View>
                  </Pressable>
                </View>
                ...
                <Pressable
                  ...
                  style={({ pressed }) => [
                    ...
                    (!fullName || !email || !phone || !password || !agreeTerms) && { opacity: 0.8, backgroundColor: "#666666" }
                  ]}
                >
                  {
                     progressLoader ? 
...
const styles = StyleSheet.create({
  ...
  scrollContainer: { flexGrow: 1, paddingBottom: "5%" },
  logoContainer: {
    width: 200,
    height: 200,
  },
  ...
  title: { fontSize: 22, fontFamily: FONTS.tenonMediumFont, color: "#264941", marginBottom: 20 },
  inputGroup: { width: "100%" },
  errorText: { color: "red", fontSize: fontPixel(14), marginTop: 4, fontFamily: FONTS.tenonMediumFont },
  ...
  termsText: { fontSize: fontPixel(16), fontFamily: FONTS.tenonRegularFont, top: 1 },
  createButton: {
    width: '100%',
  ...
  createText: { fontSize: fontPixel(16), fontFamily: FONTS.tenonMediumFont, color: "#fff" },
  loginContainer: { flexDirection: "row", justifyContent: "center", zIndex: 99, paddingBottom: 20 },
  loginText: { color: "#666666", fontSize: fontPixel(16), fontFamily: FONTS.tenonRegularFont },
  loginLink: { color: "#264941", fontSize: fontPixel(16), fontFamily: FONTS.tenonRegularFont },
  label: {
